...
if __name__ == "__main__" and "__file__" in globals():
    from _spirv_khronos import spv
    ...
    text = text.split("## " + "BELOW")[0]
    text += "## " + "BELOW IS AUTO-GENERATED" + "\n\n" + "\n".join(lines) + "\n\n"
...
AddressingModel_PhysicalStorageBuffer64 = Enum('AddressingModel_PhysicalStorageBuffer64', 5348)
AddressingModel_PhysicalStorageBuffer64EXT = Enum('AddressingModel_PhysicalStorageBuffer64EXT', 5348)
...
ExecutionMode_InputTrianglesAdjacency = Enum('ExecutionMode_InputTrianglesAdjacency', 23)
...
ExecutionMode_SubgroupsPerWorkgroupId = Enum('ExecutionMode_SubgroupsPerWorkgroupId', 37)
...
ExecutionMode_SignedZeroInfNanPreserve = Enum('ExecutionMode_SignedZeroInfNanPreserve', 4461)
...
ExecutionMode_StencilRefReplacingEXT = Enum('ExecutionMode_StencilRefReplacingEXT', 5027)
...
ExecutionMode_DerivativeGroupQuadsNV = Enum('ExecutionMode_DerivativeGroupQuadsNV', 5289)
ExecutionMode_DerivativeGroupLinearNV = Enum('ExecutionMode_DerivativeGroupLinearNV', 5290)
ExecutionMode_OutputTrianglesNV = Enum('ExecutionMode_OutputTrianglesNV', 5298)
ExecutionMode_PixelInterlockOrderedEXT = Enum('ExecutionMode_PixelInterlockOrderedEXT', 5366)
ExecutionMode_PixelInterlockUnorderedEXT = Enum('ExecutionMode_PixelInterlockUnorderedEXT', 5367)
ExecutionMode_SampleInterlockOrderedEXT = Enum('ExecutionMode_SampleInterlockOrderedEXT', 5368)
ExecutionMode_SampleInterlockUnorderedEXT = Enum('ExecutionMode_SampleInterlockUnorderedEXT', 5369)
ExecutionMode_ShadingRateInterlockOrderedEXT = Enum('ExecutionMode_ShadingRateInterlockOrderedEXT', 5370)
ExecutionMode_ShadingRateInterlockUnorderedEXT = Enum('ExecutionMode_ShadingRateInterlockUnorderedEXT', 5371)
...
StorageClass_PhysicalStorageBufferEXT = Enum('StorageClass_PhysicalStorageBufferEXT', 5349)
...
ImageChannelDataType_UnormInt101010_2 = Enum('ImageChannelDataType_UnormInt101010_2', 16)
...
ImageOperandsShift_MakeTexelAvailableKHR = Enum('ImageOperandsShift_MakeTexelAvailableKHR', 8)
ImageOperandsShift_MakeTexelVisible = Enum('ImageOperandsShift_MakeTexelVisible', 9)
ImageOperandsShift_MakeTexelVisibleKHR = Enum('ImageOperandsShift_MakeTexelVisibleKHR', 9)
ImageOperandsShift_NonPrivateTexel = Enum('ImageOperandsShift_NonPrivateTexel', 10)
ImageOperandsShift_NonPrivateTexelKHR = Enum('ImageOperandsShift_NonPrivateTexelKHR', 10)
...
ImageOperandsMask_MakeTexelAvailableKHR = Enum('ImageOperandsMask_MakeTexelAvailableKHR', 256)
ImageOperandsMask_MakeTexelVisible = Enum('ImageOperandsMask_MakeTexelVisible', 512)
ImageOperandsMask_MakeTexelVisibleKHR = Enum('ImageOperandsMask_MakeTexelVisibleKHR', 512)
ImageOperandsMask_NonPrivateTexel = Enum('ImageOperandsMask_NonPrivateTexel', 1024)
ImageOperandsMask_NonPrivateTexelKHR = Enum('ImageOperandsMask_NonPrivateTexelKHR', 1024)
...
FunctionParameterAttribute_NoReadWrite = Enum('FunctionParameterAttribute_NoReadWrite', 7)
...
Decoration_SecondaryViewportRelativeNV = Enum('Decoration_SecondaryViewportRelativeNV', 5256)
...
MemorySemanticsShift_SequentiallyConsistent = Enum('MemorySemanticsShift_SequentiallyConsistent', 4)
...
MemorySemanticsShift_CrossWorkgroupMemory = Enum('MemorySemanticsShift_CrossWorkgroupMemory', 9)
MemorySemanticsShift_AtomicCounterMemory = Enum('MemorySemanticsShift_AtomicCounterMemory', 10)
...
MemorySemanticsShift_MakeAvailableKHR = Enum('MemorySemanticsShift_MakeAvailableKHR', 13)
...
MemorySemanticsMask_SequentiallyConsistent = Enum('MemorySemanticsMask_SequentiallyConsistent', 16)
...
MemorySemanticsMask_CrossWorkgroupMemory = Enum('MemorySemanticsMask_CrossWorkgroupMemory', 512)
MemorySemanticsMask_AtomicCounterMemory = Enum('MemorySemanticsMask_AtomicCounterMemory', 1024)
...
MemorySemanticsMask_MakeAvailableKHR = Enum('MemorySemanticsMask_MakeAvailableKHR', 8192)
...
MemoryAccessShift_MakePointerAvailable = Enum('MemoryAccessShift_MakePointerAvailable', 3)
MemoryAccessShift_MakePointerAvailableKHR = Enum('MemoryAccessShift_MakePointerAvailableKHR', 3)
MemoryAccessShift_MakePointerVisible = Enum('MemoryAccessShift_MakePointerVisible', 4)
MemoryAccessShift_MakePointerVisibleKHR = Enum('MemoryAccessShift_MakePointerVisibleKHR', 4)
MemoryAccessShift_NonPrivatePointer = Enum('MemoryAccessShift_NonPrivatePointer', 5)
MemoryAccessShift_NonPrivatePointerKHR = Enum('MemoryAccessShift_NonPrivatePointerKHR', 5)
...
MemoryAccessMask_MakePointerAvailableKHR = Enum('MemoryAccessMask_MakePointerAvailableKHR', 8)
MemoryAccessMask_MakePointerVisible = Enum('MemoryAccessMask_MakePointerVisible', 16)
MemoryAccessMask_MakePointerVisibleKHR = Enum('MemoryAccessMask_MakePointerVisibleKHR', 16)
MemoryAccessMask_NonPrivatePointer = Enum('MemoryAccessMask_NonPrivatePointer', 32)
MemoryAccessMask_NonPrivatePointerKHR = Enum('MemoryAccessMask_NonPrivatePointerKHR', 32)
...
GroupOperation_PartitionedInclusiveScanNV = Enum('GroupOperation_PartitionedInclusiveScanNV', 7)
GroupOperation_PartitionedExclusiveScanNV = Enum('GroupOperation_PartitionedExclusiveScanNV', 8)
...
Capability_UniformBufferArrayDynamicIndexing = Enum('Capability_UniformBufferArrayDynamicIndexing', 28)
Capability_SampledImageArrayDynamicIndexing = Enum('Capability_SampledImageArrayDynamicIndexing', 29)
Capability_StorageBufferArrayDynamicIndexing = Enum('Capability_StorageBufferArrayDynamicIndexing', 30)
Capability_StorageImageArrayDynamicIndexing = Enum('Capability_StorageImageArrayDynamicIndexing', 31)
...
Capability_StorageImageExtendedFormats = Enum('Capability_StorageImageExtendedFormats', 49)
...
Capability_StorageImageReadWithoutFormat = Enum('Capability_StorageImageReadWithoutFormat', 55)
Capability_StorageImageWriteWithoutFormat = Enum('Capability_StorageImageWriteWithoutFormat', 56)
...
Capability_GroupNonUniformShuffleRelative = Enum('Capability_GroupNonUniformShuffleRelative', 66)
...
Capability_StorageUniformBufferBlock16 = Enum('Capability_StorageUniformBufferBlock16', 4433)
Capability_StorageUniform16 = Enum('Capability_StorageUniform16', 4434)
Capability_UniformAndStorageBuffer16BitAccess = Enum('Capability_UniformAndStorageBuffer16BitAccess', 4434)
...
Capability_VariablePointersStorageBuffer = Enum('Capability_VariablePointersStorageBuffer', 4441)
...
Capability_SampleMaskPostDepthCoverage = Enum('Capability_SampleMaskPostDepthCoverage', 4447)
Capability_StorageBuffer8BitAccess = Enum('Capability_StorageBuffer8BitAccess', 4448)
Capability_UniformAndStorageBuffer8BitAccess = Enum('Capability_UniformAndStorageBuffer8BitAccess', 4449)
...
Capability_SampleMaskOverrideCoverageNV = Enum('Capability_SampleMaskOverrideCoverageNV', 5249)
Capability_GeometryShaderPassthroughNV = Enum('Capability_GeometryShaderPassthroughNV', 5251)
Capability_ShaderViewportIndexLayerEXT = Enum('Capability_ShaderViewportIndexLayerEXT', 5254)
Capability_ShaderViewportIndexLayerNV = Enum('Capability_ShaderViewportIndexLayerNV', 5254)
...
Capability_ComputeDerivativeGroupQuadsNV = Enum('Capability_ComputeDerivativeGroupQuadsNV', 5288)
...
Capability_GroupNonUniformPartitionedNV = Enum('Capability_GroupNonUniformPartitionedNV', 5297)
...
Capability_RuntimeDescriptorArrayEXT = Enum('Capability_RuntimeDescriptorArrayEXT', 5302)
Capability_InputAttachmentArrayDynamicIndexing = Enum('Capability_InputAttachmentArrayDynamicIndexing', 5303)
Capability_InputAttachmentArrayDynamicIndexingEXT = Enum('Capability_InputAttachmentArrayDynamicIndexingEXT', 5303)
Capability_UniformTexelBufferArrayDynamicIndexing = Enum('Capability_UniformTexelBufferArrayDynamicIndexing', 5304)
Capability_UniformTexelBufferArrayDynamicIndexingEXT = Enum('Capability_UniformTexelBufferArrayDynamicIndexingEXT', 5304)
Capability_StorageTexelBufferArrayDynamicIndexing = Enum('Capability_StorageTexelBufferArrayDynamicIndexing', 5305)
Capability_StorageTexelBufferArrayDynamicIndexingEXT = Enum('Capability_StorageTexelBufferArrayDynamicIndexingEXT', 5305)
Capability_UniformBufferArrayNonUniformIndexing = Enum('Capability_UniformBufferArrayNonUniformIndexing', 5306)
Capability_UniformBufferArrayNonUniformIndexingEXT = Enum('Capability_UniformBufferArrayNonUniformIndexingEXT', 5306)
Capability_SampledImageArrayNonUniformIndexing = Enum('Capability_SampledImageArrayNonUniformIndexing', 5307)
Capability_SampledImageArrayNonUniformIndexingEXT = Enum('Capability_SampledImageArrayNonUniformIndexingEXT', 5307)
Capability_StorageBufferArrayNonUniformIndexing = Enum('Capability_StorageBufferArrayNonUniformIndexing', 5308)
Capability_StorageBufferArrayNonUniformIndexingEXT = Enum('Capability_StorageBufferArrayNonUniformIndexingEXT', 5308)
Capability_StorageImageArrayNonUniformIndexing = Enum('Capability_StorageImageArrayNonUniformIndexing', 5309)
Capability_StorageImageArrayNonUniformIndexingEXT = Enum('Capability_StorageImageArrayNonUniformIndexingEXT', 5309)
Capability_InputAttachmentArrayNonUniformIndexing = Enum('Capability_InputAttachmentArrayNonUniformIndexing', 5310)
Capability_InputAttachmentArrayNonUniformIndexingEXT = Enum('Capability_InputAttachmentArrayNonUniformIndexingEXT', 5310)
Capability_UniformTexelBufferArrayNonUniformIndexing = Enum('Capability_UniformTexelBufferArrayNonUniformIndexing', 5311)
Capability_UniformTexelBufferArrayNonUniformIndexingEXT = Enum('Capability_UniformTexelBufferArrayNonUniformIndexingEXT', 5311)
Capability_StorageTexelBufferArrayNonUniformIndexing = Enum('Capability_StorageTexelBufferArrayNonUniformIndexing', 5312)
Capability_StorageTexelBufferArrayNonUniformIndexingEXT = Enum('Capability_StorageTexelBufferArrayNonUniformIndexingEXT', 5312)
...
Capability_VulkanMemoryModelDeviceScope = Enum('Capability_VulkanMemoryModelDeviceScope', 5346)
Capability_VulkanMemoryModelDeviceScopeKHR = Enum('Capability_VulkanMemoryModelDeviceScopeKHR', 5346)
Capability_PhysicalStorageBufferAddresses = Enum('Capability_PhysicalStorageBufferAddresses', 5347)
Capability_PhysicalStorageBufferAddressesEXT = Enum('Capability_PhysicalStorageBufferAddressesEXT', 5347)
Capability_ComputeDerivativeGroupLinearNV = Enum('Capability_ComputeDerivativeGroupLinearNV', 5350)
Capability_CooperativeMatrixNV = Enum('Capability_CooperativeMatrixNV', 5357)
Capability_FragmentShaderSampleInterlockEXT = Enum('Capability_FragmentShaderSampleInterlockEXT', 5363)
Capability_FragmentShaderShadingRateInterlockEXT = Enum('Capability_FragmentShaderShadingRateInterlockEXT', 5372)
Capability_ShaderSMBuiltinsNV = Enum('Capability_ShaderSMBuiltinsNV', 5373)
Capability_FragmentShaderPixelInterlockEXT = Enum('Capability_FragmentShaderPixelInterlockEXT', 5378)
Capability_DemoteToHelperInvocationEXT = Enum('Capability_DemoteToHelperInvocationEXT', 5379)
Capability_SubgroupShuffleINTEL = Enum('Capability_SubgroupShuffleINTEL', 5568)
Capability_SubgroupBufferBlockIOINTEL = Enum('Capability_SubgroupBufferBlockIOINTEL', 5569)
Capability_SubgroupImageBlockIOINTEL = Enum('Capability_SubgroupImageBlockIOINTEL', 5570)
Capability_SubgroupImageMediaBlockIOINTEL = Enum('Capability_SubgroupImageMediaBlockIOINTEL', 5579)
Capability_IntegerFunctions2INTEL = Enum('Capability_IntegerFunctions2INTEL', 5584)
Capability_SubgroupAvcMotionEstimationINTEL = Enum('Capability_SubgroupAvcMotionEstimationINTEL', 5696)
Capability_SubgroupAvcMotionEstimationIntraINTEL = Enum('Capability_SubgroupAvcMotionEstimationIntraINTEL', 5697)
Capability_SubgroupAvcMotionEstimationChromaINTEL = Enum('Capability_SubgroupAvcMotionEstimationChromaINTEL', 5698)
...
OpGetKernelPreferredWorkGroupSizeMultiple = Enum('OpGetKernelPreferredWorkGroupSizeMultiple', 296)
...
OpImageSparseSampleProjDrefImplicitLod = Enum('OpImageSparseSampleProjDrefImplicitLod', 311)
OpImageSparseSampleProjDrefExplicitLod = Enum('OpImageSparseSampleProjDrefExplicitLod', 312)
...
OpTypeAvcImeResultSingleReferenceStreamoutINTEL = Enum('OpTypeAvcImeResultSingleReferenceStreamoutINTEL', 5707)
OpTypeAvcImeResultDualReferenceStreamoutINTEL = Enum('OpTypeAvcImeResultDualReferenceStreamoutINTEL', 5708)
OpTypeAvcImeSingleReferenceStreaminINTEL = Enum('OpTypeAvcImeSingleReferenceStreaminINTEL', 5709)
OpTypeAvcImeDualReferenceStreaminINTEL = Enum('OpTypeAvcImeDualReferenceStreaminINTEL', 5710)
OpTypeAvcRefResultINTEL = Enum('OpTypeAvcRefResultINTEL', 5711)
OpTypeAvcSicResultINTEL = Enum('OpTypeAvcSicResultINTEL', 5712)
OpSubgroupAvcMceGetDefaultInterBaseMultiReferencePenaltyINTEL = Enum('OpSubgroupAvcMceGetDefaultInterBaseMultiReferencePenaltyINTEL', 5713)
OpSubgroupAvcMceSetInterBaseMultiReferencePenaltyINTEL = Enum('OpSubgroupAvcMceSetInterBaseMultiReferencePenaltyINTEL', 5714)
OpSubgroupAvcMceGetDefaultInterShapePenaltyINTEL = Enum('OpSubgroupAvcMceGetDefaultInterShapePenaltyINTEL', 5715)
OpSubgroupAvcMceSetInterShapePenaltyINTEL = Enum('OpSubgroupAvcMceSetInterShapePenaltyINTEL', 5716)
OpSubgroupAvcMceGetDefaultInterDirectionPenaltyINTEL = Enum('OpSubgroupAvcMceGetDefaultInterDirectionPenaltyINTEL', 5717)
OpSubgroupAvcMceSetInterDirectionPenaltyINTEL = Enum('OpSubgroupAvcMceSetInterDirectionPenaltyINTEL', 5718)
OpSubgroupAvcMceGetDefaultIntraLumaShapePenaltyINTEL = Enum('OpSubgroupAvcMceGetDefaultIntraLumaShapePenaltyINTEL', 5719)
OpSubgroupAvcMceGetDefaultInterMotionVectorCostTableINTEL = Enum('OpSubgroupAvcMceGetDefaultInterMotionVectorCostTableINTEL', 5720)
OpSubgroupAvcMceGetDefaultHighPenaltyCostTableINTEL = Enum('OpSubgroupAvcMceGetDefaultHighPenaltyCostTableINTEL', 5721)
OpSubgroupAvcMceGetDefaultMediumPenaltyCostTableINTEL = Enum('OpSubgroupAvcMceGetDefaultMediumPenaltyCostTableINTEL', 5722)
OpSubgroupAvcMceGetDefaultLowPenaltyCostTableINTEL = Enum('OpSubgroupAvcMceGetDefaultLowPenaltyCostTableINTEL', 5723)
OpSubgroupAvcMceSetMotionVectorCostFunctionINTEL = Enum('OpSubgroupAvcMceSetMotionVectorCostFunctionINTEL', 5724)
OpSubgroupAvcMceGetDefaultIntraLumaModePenaltyINTEL = Enum('OpSubgroupAvcMceGetDefaultIntraLumaModePenaltyINTEL', 5725)
OpSubgroupAvcMceGetDefaultNonDcLumaIntraPenaltyINTEL = Enum('OpSubgroupAvcMceGetDefaultNonDcLumaIntraPenaltyINTEL', 5726)
OpSubgroupAvcMceGetDefaultIntraChromaModeBasePenaltyINTEL = Enum('OpSubgroupAvcMceGetDefaultIntraChromaModeBasePenaltyINTEL', 5727)
OpSubgroupAvcMceSetAcOnlyHaarINTEL = Enum('OpSubgroupAvcMceSetAcOnlyHaarINTEL', 5728)
OpSubgroupAvcMceSetSourceInterlacedFieldPolarityINTEL = Enum('OpSubgroupAvcMceSetSourceInterlacedFieldPolarityINTEL', 5729)
OpSubgroupAvcMceSetSingleReferenceInterlacedFieldPolarityINTEL = Enum('OpSubgroupAvcMceSetSingleReferenceInterlacedFieldPolarityINTEL', 5730)
OpSubgroupAvcMceSetDualReferenceInterlacedFieldPolaritiesINTEL = Enum('OpSubgroupAvcMceSetDualReferenceInterlacedFieldPolaritiesINTEL', 5731)
OpSubgroupAvcMceConvertToImePayloadINTEL = Enum('OpSubgroupAvcMceConvertToImePayloadINTEL', 5732)
OpSubgroupAvcMceConvertToImeResultINTEL = Enum('OpSubgroupAvcMceConvertToImeResultINTEL', 5733)
OpSubgroupAvcMceConvertToRefPayloadINTEL = Enum('OpSubgroupAvcMceConvertToRefPayloadINTEL', 5734)
OpSubgroupAvcMceConvertToRefResultINTEL = Enum('OpSubgroupAvcMceConvertToRefResultINTEL', 5735)
OpSubgroupAvcMceConvertToSicPayloadINTEL = Enum('OpSubgroupAvcMceConvertToSicPayloadINTEL', 5736)
OpSubgroupAvcMceConvertToSicResultINTEL = Enum('OpSubgroupAvcMceConvertToSicResultINTEL', 5737)
OpSubgroupAvcMceGetMotionVectorsINTEL = Enum('OpSubgroupAvcMceGetMotionVectorsINTEL', 5738)
OpSubgroupAvcMceGetInterDistortionsINTEL = Enum('OpSubgroupAvcMceGetInterDistortionsINTEL', 5739)
OpSubgroupAvcMceGetBestInterDistortionsINTEL = Enum('OpSubgroupAvcMceGetBestInterDistortionsINTEL', 5740)
OpSubgroupAvcMceGetInterMajorShapeINTEL = Enum('OpSubgroupAvcMceGetInterMajorShapeINTEL', 5741)
OpSubgroupAvcMceGetInterMinorShapeINTEL = Enum('OpSubgroupAvcMceGetInterMinorShapeINTEL', 5742)
OpSubgroupAvcMceGetInterDirectionsINTEL = Enum('OpSubgroupAvcMceGetInterDirectionsINTEL', 5743)
OpSubgroupAvcMceGetInterMotionVectorCountINTEL = Enum('OpSubgroupAvcMceGetInterMotionVectorCountINTEL', 5744)
OpSubgroupAvcMceGetInterReferenceIdsINTEL = Enum('OpSubgroupAvcMceGetInterReferenceIdsINTEL', 5745)
OpSubgroupAvcMceGetInterReferenceInterlacedFieldPolaritiesINTEL = Enum('OpSubgroupAvcMceGetInterReferenceInterlacedFieldPolaritiesINTEL', 5746)
OpSubgroupAvcImeInitializeINTEL = Enum('OpSubgroupAvcImeInitializeINTEL', 5747)
OpSubgroupAvcImeSetSingleReferenceINTEL = Enum('OpSubgroupAvcImeSetSingleReferenceINTEL', 5748)
OpSubgroupAvcImeSetDualReferenceINTEL = Enum('OpSubgroupAvcImeSetDualReferenceINTEL', 5749)
OpSubgroupAvcImeRefWindowSizeINTEL = Enum('OpSubgroupAvcImeRefWindowSizeINTEL', 5750)
OpSubgroupAvcImeAdjustRefOffsetINTEL = Enum('OpSubgroupAvcImeAdjustRefOffsetINTEL', 5751)
OpSubgroupAvcImeConvertToMcePayloadINTEL = Enum('OpSubgroupAvcImeConvertToMcePayloadINTEL', 5752)
OpSubgroupAvcImeSetMaxMotionVectorCountINTEL = Enum('OpSubgroupAvcImeSetMaxMotionVectorCountINTEL', 5753)
OpSubgroupAvcImeSetUnidirectionalMixDisableINTEL = Enum('OpSubgroupAvcImeSetUnidirectionalMixDisableINTEL', 5754)
OpSubgroupAvcImeSetEarlySearchTerminationThresholdINTEL = Enum('OpSubgroupAvcImeSetEarlySearchTerminationThresholdINTEL', 5755)
OpSubgroupAvcImeSetWeightedSadINTEL = Enum('OpSubgroupAvcImeSetWeightedSadINTEL', 5756)
OpSubgroupAvcImeEvaluateWithSingleReferenceINTEL = Enum('OpSubgroupAvcImeEvaluateWithSingleReferenceINTEL', 5757)
OpSubgroupAvcImeEvaluateWithDualReferenceINTEL = Enum('OpSubgroupAvcImeEvaluateWithDualReferenceINTEL', 5758)
OpSubgroupAvcImeEvaluateWithSingleReferenceStreaminINTEL = Enum('OpSubgroupAvcImeEvaluateWithSingleReferenceStreaminINTEL', 5759)
OpSubgroupAvcImeEvaluateWithDualReferenceStreaminINTEL = Enum('OpSubgroupAvcImeEvaluateWithDualReferenceStreaminINTEL', 5760)
OpSubgroupAvcImeEvaluateWithSingleReferenceStreamoutINTEL = Enum('OpSubgroupAvcImeEvaluateWithSingleReferenceStreamoutINTEL', 5761)
OpSubgroupAvcImeEvaluateWithDualReferenceStreamoutINTEL = Enum('OpSubgroupAvcImeEvaluateWithDualReferenceStreamoutINTEL', 5762)
OpSubgroupAvcImeEvaluateWithSingleReferenceStreaminoutINTEL = Enum('OpSubgroupAvcImeEvaluateWithSingleReferenceStreaminoutINTEL', 5763)
OpSubgroupAvcImeEvaluateWithDualReferenceStreaminoutINTEL = Enum('OpSubgroupAvcImeEvaluateWithDualReferenceStreaminoutINTEL', 5764)
OpSubgroupAvcImeConvertToMceResultINTEL = Enum('OpSubgroupAvcImeConvertToMceResultINTEL', 5765)
OpSubgroupAvcImeGetSingleReferenceStreaminINTEL = Enum('OpSubgroupAvcImeGetSingleReferenceStreaminINTEL', 5766)
OpSubgroupAvcImeGetDualReferenceStreaminINTEL = Enum('OpSubgroupAvcImeGetDualReferenceStreaminINTEL', 5767)
OpSubgroupAvcImeStripSingleReferenceStreamoutINTEL = Enum('OpSubgroupAvcImeStripSingleReferenceStreamoutINTEL', 5768)
OpSubgroupAvcImeStripDualReferenceStreamoutINTEL = Enum('OpSubgroupAvcImeStripDualReferenceStreamoutINTEL', 5769)
OpSubgroupAvcImeGetStreamoutSingleReferenceMajorShapeMotionVectorsINTEL = Enum('OpSubgroupAvcImeGetStreamoutSingleReferenceMajorShapeMotionVectorsINTEL', 5770)
OpSubgroupAvcImeGetStreamoutSingleReferenceMajorShapeDistortionsINTEL = Enum('OpSubgroupAvcImeGetStreamoutSingleReferenceMajorShapeDistortionsINTEL', 5771)
OpSubgroupAvcImeGetStreamoutSingleReferenceMajorShapeReferenceIdsINTEL = Enum('OpSubgroupAvcImeGetStreamoutSingleReferenceMajorShapeReferenceIdsINTEL', 5772)
OpSubgroupAvcImeGetStreamoutDualReferenceMajorShapeMotionVectorsINTEL = Enum('OpSubgroupAvcImeGetStreamoutDualReferenceMajorShapeMotionVectorsINTEL', 5773)
OpSubgroupAvcImeGetStreamoutDualReferenceMajorShapeDistortionsINTEL = Enum('OpSubgroupAvcImeGetStreamoutDualReferenceMajorShapeDistortionsINTEL', 5774)
OpSubgroupAvcImeGetStreamoutDualReferenceMajorShapeReferenceIdsINTEL = Enum('OpSubgroupAvcImeGetStreamoutDualReferenceMajorShapeReferenceIdsINTEL', 5775)
OpSubgroupAvcImeGetBorderReachedINTEL = Enum('OpSubgroupAvcImeGetBorderReachedINTEL', 5776)
OpSubgroupAvcImeGetTruncatedSearchIndicationINTEL = Enum('OpSubgroupAvcImeGetTruncatedSearchIndicationINTEL', 5777)
OpSubgroupAvcImeGetUnidirectionalEarlySearchTerminationINTEL = Enum('OpSubgroupAvcImeGetUnidirectionalEarlySearchTerminationINTEL', 5778)
OpSubgroupAvcImeGetWeightingPatternMinimumMotionVectorINTEL = Enum('OpSubgroupAvcImeGetWeightingPatternMinimumMotionVectorINTEL', 5779)
OpSubgroupAvcImeGetWeightingPatternMinimumDistortionINTEL = Enum('OpSubgroupAvcImeGetWeightingPatternMinimumDistortionINTEL', 5780)
...
OpSubgroupAvcRefConvertToMcePayloadINTEL = Enum('OpSubgroupAvcRefConvertToMcePayloadINTEL', 5783)
OpSubgroupAvcRefSetBidirectionalMixDisableINTEL = Enum('OpSubgroupAvcRefSetBidirectionalMixDisableINTEL', 5784)
OpSubgroupAvcRefSetBilinearFilterEnableINTEL = Enum('OpSubgroupAvcRefSetBilinearFilterEnableINTEL', 5785)
OpSubgroupAvcRefEvaluateWithSingleReferenceINTEL = Enum('OpSubgroupAvcRefEvaluateWithSingleReferenceINTEL', 5786)
OpSubgroupAvcRefEvaluateWithDualReferenceINTEL = Enum('OpSubgroupAvcRefEvaluateWithDualReferenceINTEL', 5787)
OpSubgroupAvcRefEvaluateWithMultiReferenceINTEL = Enum('OpSubgroupAvcRefEvaluateWithMultiReferenceINTEL', 5788)
OpSubgroupAvcRefEvaluateWithMultiReferenceInterlacedINTEL = Enum('OpSubgroupAvcRefEvaluateWithMultiReferenceInterlacedINTEL', 5789)
OpSubgroupAvcRefConvertToMceResultINTEL = Enum('OpSubgroupAvcRefConvertToMceResultINTEL', 5790)
...
OpSubgroupAvcSicConfigureIpeLumaINTEL = Enum('OpSubgroupAvcSicConfigureIpeLumaINTEL', 5793)
OpSubgroupAvcSicConfigureIpeLumaChromaINTEL = Enum('OpSubgroupAvcSicConfigureIpeLumaChromaINTEL', 5794)
OpSubgroupAvcSicGetMotionVectorMaskINTEL = Enum('OpSubgroupAvcSicGetMotionVectorMaskINTEL', 5795)
OpSubgroupAvcSicConvertToMcePayloadINTEL = Enum('OpSubgroupAvcSicConvertToMcePayloadINTEL', 5796)
OpSubgroupAvcSicSetIntraLumaShapePenaltyINTEL = Enum('OpSubgroupAvcSicSetIntraLumaShapePenaltyINTEL', 5797)
OpSubgroupAvcSicSetIntraLumaModeCostFunctionINTEL = Enum('OpSubgroupAvcSicSetIntraLumaModeCostFunctionINTEL', 5798)
OpSubgroupAvcSicSetIntraChromaModeCostFunctionINTEL = Enum('OpSubgroupAvcSicSetIntraChromaModeCostFunctionINTEL', 5799)
OpSubgroupAvcSicSetBilinearFilterEnableINTEL = Enum('OpSubgroupAvcSicSetBilinearFilterEnableINTEL', 5800)
OpSubgroupAvcSicSetSkcForwardTransformEnableINTEL = Enum('OpSubgroupAvcSicSetSkcForwardTransformEnableINTEL', 5801)
OpSubgroupAvcSicSetBlockBasedRawSkipSadINTEL = Enum('OpSubgroupAvcSicSetBlockBasedRawSkipSadINTEL', 5802)
OpSubgroupAvcSicEvaluateIpeINTEL = Enum('OpSubgroupAvcSicEvaluateIpeINTEL', 5803)
OpSubgroupAvcSicEvaluateWithSingleReferenceINTEL = Enum('OpSubgroupAvcSicEvaluateWithSingleReferenceINTEL', 5804)
OpSubgroupAvcSicEvaluateWithDualReferenceINTEL = Enum('OpSubgroupAvcSicEvaluateWithDualReferenceINTEL', 5805)
OpSubgroupAvcSicEvaluateWithMultiReferenceINTEL = Enum('OpSubgroupAvcSicEvaluateWithMultiReferenceINTEL', 5806)
OpSubgroupAvcSicEvaluateWithMultiReferenceInterlacedINTEL = Enum('OpSubgroupAvcSicEvaluateWithMultiReferenceInterlacedINTEL', 5807)
OpSubgroupAvcSicConvertToMceResultINTEL = Enum('OpSubgroupAvcSicConvertToMceResultINTEL', 5808)
OpSubgroupAvcSicGetIpeLumaShapeINTEL = Enum('OpSubgroupAvcSicGetIpeLumaShapeINTEL', 5809)
OpSubgroupAvcSicGetBestIpeLumaDistortionINTEL = Enum('OpSubgroupAvcSicGetBestIpeLumaDistortionINTEL', 5810)
OpSubgroupAvcSicGetBestIpeChromaDistortionINTEL = Enum('OpSubgroupAvcSicGetBestIpeChromaDistortionINTEL', 5811)
OpSubgroupAvcSicGetPackedIpeLumaModesINTEL = Enum('OpSubgroupAvcSicGetPackedIpeLumaModesINTEL', 5812)
OpSubgroupAvcSicGetIpeChromaModeINTEL = Enum('OpSubgroupAvcSicGetIpeChromaModeINTEL', 5813)
OpSubgroupAvcSicGetPackedSkcLumaCountThresholdINTEL = Enum('OpSubgroupAvcSicGetPackedSkcLumaCountThresholdINTEL', 5814)
OpSubgroupAvcSicGetPackedSkcLumaSumThresholdINTEL = Enum('OpSubgroupAvcSicGetPackedSkcLumaSumThresholdINTEL', 5815)
OpSubgroupAvcSicGetInterRawSadsINTEL = Enum('OpSubgroupAvcSicGetInterRawSadsINTEL', 5816)
