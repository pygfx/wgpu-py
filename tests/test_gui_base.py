...
def test_event_target_mixin():
    ...
    c.handle_event(wgpu.gui.events.Event(type="foo", value=1))
    c.handle_event(wgpu.gui.events.Event(type="bar", value=2))
    c.handle_event(wgpu.gui.events.Event(type="spam", value=3))
    c.remove_event_handler(handler, "foo")
    c.handle_event(wgpu.gui.events.Event(type="foo", value=4))
    c.handle_event(wgpu.gui.events.Event(type="bar", value=5))
    c.handle_event(wgpu.gui.events.Event(type="spam", value=6))
    c.remove_event_handler(handler, "bar")
    c.handle_event(wgpu.gui.events.Event(type="foo", value=7))
    c.handle_event(wgpu.gui.events.Event(type="bar", value=8))
    c.handle_event(wgpu.gui.events.Event(type="spam", value=9))
