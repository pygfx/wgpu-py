...
* Diffs for GPUCanvasContext: add get_preferred_format, add present, add set_physical_size, hide canvas
...
* Validated 38 classes, 120 methods, 49 properties
### Patching API for backends/wgpu_native/_api.py
* Validated 38 classes, 114 methods, 0 properties
